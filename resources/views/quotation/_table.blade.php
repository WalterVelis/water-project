...
<table class="table c-table">
    ...
    <tbody id="q-response">
        <tr>
            ...
            <td>1</td>
            <td style="text-align: right" class="currency"><span>$</span>{{ Helper::formatMoney($totalManoDeObra) }}</td>
            ...
            <td style="text-align: right" class="currency"><span>$</span>{{ Helper::formatMoney(( ($totalManoDeObra / (((100 - $costsUtility->utility) / 100))) + (($totalManoDeObra / (((100 - $costsUtility->utility) / 100))) * ((($costsUtility->indirect) / 100))))) }}</td>
        ...
        <tr>
            ...
            <td style="text-align: right;" class="currency"><span>$</span>{{ Helper::formatMoney($escuela->children * ( ($schoolCost->cost / (((100 - $schoolCost->utility) / 100))) + (($schoolCost->cost / (((100 - $schoolCost->utility) / 100))) * ((($schoolCost->indirect) / 100))))) }}</td>
        ...
        <tr>
            ...
            <td>1</td>
            <td style="text-align: right" class="currency"><span>$</span>{{ Helper::formatMoney($allMaterials) }}</td>
            ...
            <td style="text-align: right" class="currency"><span>$</span>{{ Helper::formatMoney(( ($allMaterials / (((100 - $materialUtility->utility) / 100))) + (($allMaterials / (((100 - $materialUtility->utility) / 100))) * ((($materialUtility->indirect) / 100))))) }}</td>
        ...
        <tr class="q-details" style="display: none;">
            ...
            <td>
                <div class="row">
                    ...
                    <div style="text-align: right;" class="col-6"class="currency"><span>$</span>{{ Helper::formatMoney($totalMaterial) }}</div>
                    <div style="text-align: right;" class="col-6">Accesorios IU</div>
                    <div style="text-align: right;" class="col-6"class="currency"><span>$</span>{{ Helper::formatMoney($totalIU) }}</div>
                </div>
            </td>
            <td></td>
            <td></td>
        ...
        <tr class="has-icon">
            ...
            <td>{{ $q->description }}</td>
            <td>{{ $q->qty }}</td>
            <td style="text-align: right;" class="currency"><span>$</span>{{ Helper::formatMoney($q->cost) }}</td>
            ...
            <td style="text-align: right;" class="currency"><span>$</span>{{ Helper::formatMoney($q->qty * ( ($q->cost / (((100 - $q->utility) / 100))) + (($q->cost / (((100 - $q->utility) / 100))) * ((($q->indirect) / 100))))) }}</td>
        ...
        @endforeach
        <tr>
            <td style="text-align: right" colspan="7"><div class="row"><div style="font-weight: bold" class="col-10">Subtotal:</div> <div class="col-2 currency"><span>$</span>{{ Helper::formatMoney($subTotal) }} </div></div></td>
        </tr>
        <tr>
            <td style="text-align: right" colspan="7"><div class="row"><div style="font-weight: bold" class="col-10">IVA:</div> <div class="col-2 currency"><span>$</span>{{ Helper::formatMoney($subTotal * 0.16) }}</div></div></td>
        </tr>
        <tr>
            <td style="text-align: right" colspan="7"><div class="row"><div style="font-weight: bold" class="col-10">Total:</div> <div class="col-2 currency"><span>$</span>{{ Helper::formatMoney($subTotal * 1.16) }}</div></div></td>
        </tr>
    </tbody>
</table>
