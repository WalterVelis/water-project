...
<table class="table c-table">
    ...
    <tbody id="q-response">
        ...
        <tr>
            ...
            <td>{{ Helper::formatMoney($escuela->children * ( ($schoolCost->cost / (((100 - $schoolCost->utility) / 100))) + (($schoolCost->cost / (((100 - $schoolCost->utility) / 100))) * ((($schoolCost->indirect) / 100))))) }}</td>
