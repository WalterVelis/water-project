            ...
            <div class="col-md-12">
                <div id="all-container">
                    ...
                    <div style="text-align: right;" class="mb-2 mt-2 mr-4">
                        ...
                        @if (App\User::hasPermissions("Admin") || App\User::hasPermissions("Tech"))<span onclick="$('#sendQuotation').hide();$('#applyUtility').show();" style="    text-align: left;cursor: pointer;width:30px; height: 30px; border-radius:40px; font-weight:bold; background: #0b6696; color: white; display:inline-block;padding-left:8px;font-size:1.2em;padding-top:5px;">%</span>@endif
                    ...
                    <div class="row float-right mr-4">
                        ...
                        <button type="button" onclick="submitQForm(); " class="btn btn-primary">{{ __('SAVE') }}</button>
                    </div>
                </div>
