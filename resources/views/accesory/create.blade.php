@extends('layouts.app', ['activePage' => 'costs-iu', 'menuParent' => 'costs-parent', 'titlePage' => 'Centro de Costos'])
@section('content')
<div class="content">
                        ...
                        <div class="card-body">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-4">
                                        <label class="col-12" style="margin-bottom:-12px; font-weight:bold;    white-space: nowrap;">{{ __('Precio unitario con IVA') }}</label>
                                        <div class="col-sm-12">
