                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text" placeholder="{{ __('Name') }}" value="{{ old('name', $user->name) }}" required />
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                      <input onkeyup="emailUnique();" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" id="input-email" type="email" placeholder="{{ __('Email') }}" value="{{ old('email', $user->email) }}" required />
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('role_id') ? ' has-danger' : '' }}">
                      <select {{$isVendor}} onchange="roleDetection();" class="js-example-basic-single js-states form-control" style="width: 100%" id="role_input" name="role_id" data-style="select-with-transition" title="" data-size="100" required>
              ...
              <div id="vendorDiv" class="row {{$classVendor}}">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group form-check-inline">
                      ...
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" id="radio2X" type="radio" name="is_external" value="1" checked>@lang('External Vendor')
                          <span class="circle">
                            <span class="check"></span>
                          </span>
                        </label>
                      ...
                      <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" id="radio1X" type="radio" name="is_external" value="0" checked>@lang('Internal Vendor')
                          <span class="circle">
                            <span class="check"></span>
                          </span>
                        </label>
