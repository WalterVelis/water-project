...
<body>
    ...
    <div style="background: #dde9f2; padding:20px;    max-width: 600px; margin: 0 auto;border-radius:4px;">
        <span><b>{{ $data->admin->name }}</b> le asignó el proyecto <b>{{ $data->page }} {{ $data->client }}</b> para realizar un levantamiento técnico. Presione el siguiente botón para ingresar al proyecto.</span>
        <br>
