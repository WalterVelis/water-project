...
<body>
    ...
    <div style="background: #dde9f2; padding:20px;    max-width: 600px; margin: 0 auto;border-radius:4px;">
        <span><b>{{ $data->user->name }}</b> requiere asignación de un técnico para realizar un levantamiento técnico del proyecto <b>{{ $data->page }} {{ $data->client }}</b>. Presione el siguiente botón para ingresar al proyecto.</span>
        <br>
