...
<body>
    ...
    <div style="background: #dde9f2; padding:20px;    max-width: 600px; margin: 0 auto;border-radius:4px;">
        <span><b>{{ $data->tech->name }}</b> finalizó el registro de levantamiento técnico del proyecto <b>{{ $data->page }}</b> asignado. Presione el siguiente botón para ingresar al proyecto.</span>
        <br>
