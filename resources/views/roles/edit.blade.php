      ...
      <div class="row">
        <div class="col-md-6">
            <div class="card ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-9">
                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                      <input onkeypress="return lettersOnlySpace(event)" onpaste="return false" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text" placeholder="{{ __('Name') }}" value="{{ $role->name }}" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-9">
                    <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                      <textarea cols="30" rows="1" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" id="input-description" type="text" placeholder="{{ __('Description') }}" aria-required="true">{{ $role->description }}</textarea>
                ...
                <div class="row d-none">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group">
                      <input class="form-control" name="permissionCount" id="input-permissionCount" type="number" placeholder="0" value="{{ sizeof($role->rolePermission) }}"/>                      
                    </div>
                  </div>
                </div>
                <h6 class="card-description" style="color: black; margin-top: 1rem;">@lang('Assigned Permissions List')</h6>
                  ...
                  <div class="table-responsive divRol" style="height: 10rem;">
                    <table class="table" id="tablePA">
                      ...
                      @foreach ($role->rolePermission as $permission)
                        ...
                        <td id='selectedColumn02-{{$loop->index}}' >{{$permission->permission->description}}</td>
                        <td id='selectedColumn03-{{$loop->index}}' class='d-none'>{{$permission->permission->id}} 
                        <input type='text' name='idPermission[]' value='{{$permission->permission->id}}' />
                        </td>
              ...
              <div class="card-footer d-flex flex-row-reverse" style="padding-top: 0px">
                <p class="btn btn-rose btn-round pull-right" onclick='PermissionDataValidationUpdate("{{$role->name}}");'>{{ __('Save') }}</p>
              </div>
              <div class="d-none">
        ...
        <div class="col-md-6">
          <div class="card ">
            <div class="card-header card-header-rose card-header-icon">
              <div class="card-icon" style="background-image: url({{asset("img/icons").'/Filtro.png'}});">
                <i class="material-icons">f</i>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-md-7">
                      <div class="form-group">
                      <input id="inputFP" onkeyup="filterPermissions();" type="text" class="form-control" placeholder="{{ __('Permission Name') }}">
                      </div>
                    </div>
                  </div>
                </div>
