                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group{{ $errors->has('denomination') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('denomination') ? ' is-invalid' : '' }}" name="denomination" id="input-denomination" type="text" value="{{ old('denomination') }}" required />
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group{{ $errors->has('contact_name') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('contact_name') ? ' is-invalid' : '' }}" name="contact_name" id="input-contact_name" type="text" value="{{ old('contact_name') }}" required />
                                            <span id="errorNameUser" class="d-none">@lang('The name field cannot be empty')</span>
                                            @include('alerts.feedback', ['field' => 'name'])
                                        </div>
                                    </div>
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group{{ $errors->has('job_title') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('job_title') ? ' is-invalid' : '' }}" name="job_title" id="input-job_title" type="text" value="{{ old('job_title') }}" required />
                                            <span id="errorNameUser" class="d-none">@lang('The name field cannot be empty')</span>
                                            @include('alerts.feedback', ['field' => 'name'])
                                        </div>
                                    </div>
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group{{ $errors->has('phone') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" id="input-phone" type="text" value="{{ old('phone') }}" required />
                                            <span id="errorNameUser" class="d-none">@lang('The name field cannot be empty')</span>
                                            @include('alerts.feedback', ['field' => 'name'])
                                        </div>
                                    </div>
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" id="input-email" type="email" value="{{ old('email') }}" required />
                                            <span id="errorNameUser" class="d-none">@lang('The name field cannot be empty')</span>
                                            @include('alerts.feedback', ['field' => 'name'])
                                        </div>
                                    </div>
