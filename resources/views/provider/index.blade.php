                            ...
                            <div class="row col-12">
                                ...
                                <div class="dropdown" style="position: absolute; right: 0px;">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="costmenu">
                                        <a class="dropdown-item" href="/providerCsv/"><p class=""><i class="fa fa-file-code-o" aria-hidden="true"></i>&nbsp; CSV</p></a>
                                        <a class="dropdown-item" href="/providerXlsx/"><p class=""><i class="fa fa-file-excel-o" aria-hidden="true"></i>&nbsp; XLSX</p></a>
                                        <a class="dropdown-item" href="/providerPdf/"><p class=""><i class="fa fa-file-pdf-o" aria-hidden="true"></i>&nbsp; PDF</p></a>
                                    </div>
                                </div>
