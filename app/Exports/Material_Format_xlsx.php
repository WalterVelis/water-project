...
class Material_Format_xlsx implements FromCollection, ShouldAutoSize, WithHeadings, WithCustomStartCell, WithEvents, WithTitle, WithDrawings, WithMapping
{
    ...
    public function registerEvents(): array  // Function where styles are detailed.
    {
        return [
    		...
    		AfterSheet::class => function(AfterSheet $event) {
	            ...
	            $event->sheet->setCellValue('A1', ' Materiales');    // Insert text
